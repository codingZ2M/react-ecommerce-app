    ...
    <div className="relative h-96 container mx-auto my-12 ">
      <div className="absolute top-0 left-0 w-full h-full bg-cover bg-center" style={{ backgroundImage: `url('https://images.pexels.com/photos/6438290/pexels-photo-6438290.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')` }}>
        <div className="relative flex flex-col items-center justify-center w-full h-full bg-gray-900 bg-opacity-50">
          <h1 className="text-5xl font-bold text-white sm:text-7xl">30% Off on Casual Shoes</h1>
          <p className="mt-4 text-xl text-white">Browse our shoe collection & find the perfect one.</p>
